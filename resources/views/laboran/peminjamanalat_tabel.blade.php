        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <form action="{{ route('laboran.peminjamanalat.index') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="input-group date col-md-6 my-2">
                                ...
                                <a href="{{ route('laboran.peminjamanalat.index') }}" type="reset" class="btn btn-danger btn-small mx-2"><i class="fa fa-sync"></i> Reset</a>
                                @if($cari == '1')
                                ...
                                <a href="{{ route('laboran.peminjamanalat.grafik') }}" class="btn btn-primary btn-small mx-2"><i class="far fa-chart-bar"></i></a>
                                @endif
                            </div>
                        </div>
                    </form>
                    <div class="float-right mb-2">
                        <a href="{{ route('laboran.peminjamanalat.input') }}" class="btn btn-primary btn-small"><i class="fa fa-plus"></i>Tambah Peminjaman Alat</a>
                    </div>
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="row">
                                    <div class="col-md-4">
                                        <a href="@if($item->deleted_at != NULL) {{route('laboran.peminjamanalat.index')}} @else {{route('laboran.peminjamanalat.edit', $item->peminjamanalat_id)}} @endif" class="btn btn-primary btn-small @if($item->deleted_at != NULL) disabled @endif">Edit</a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
                    ...
                    <div class="float-right mb-4">
                        <button class="btn btn-primary btn-small" id="btn_verifikasi_peminjamanalat"><i class="fa fa-check"></i>&nbsp;&nbsp;Ajukan Verifikasi Data yang Dipilih</button>
                    </div>
                    @if($per_page != 0)
