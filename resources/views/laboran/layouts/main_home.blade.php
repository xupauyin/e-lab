<!-- ini bagian header -->
@include('laboran.layouts.header_home')
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="{{ route('laboran.profil') }}">
        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center" style="margin-top:25vh">
                ...
                <div class="col-lg-2 mb-4">
                    <a href="{{ route('laboran.inventaris.index') }}">
                        <div class="card" style="height: 10rem;">
                            <div class="card-body text-center">
                ...
                <div class="col-lg-2 mb-4">
                    <a href="{{ route('laboran.jurnal.index') }}">
                        <div class="card" style="height: 10rem;">
                            <div class="card-body text-center">
                ...
                <div class="col-lg-2 mb-4">
                    <a href="{{ route('laboran.peminjamanalat.index') }}">
                        <div class="card" style="height: 10rem;">
                            <div class="card-body text-center">
                ...
                <div class="col-lg-2 mb-4">
                    <a href="{{ route('laboran.peminjamanlab.index') }}">
                        <div class="card" style="height: 10rem;">
                            <div class="card-body text-center">
    ...
    <!-- ini bagian footer  -->
    @include('laboran.layouts.footer')