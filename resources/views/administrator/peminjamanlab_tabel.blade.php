        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <form action="{{ route('administrator.peminjamanlab.index') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="input-group date col-md-4 my-2">
                                ...
                                <a href="{{ route('administrator.peminjamanlab.index') }}" type="reset" class="btn btn-danger btn-small mx-2"><i class="fa fa-sync"></i> Reset</a>
                            </div>
                        </div>
                    </form>
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @foreach($peminjamanlab->all() as $i => $item)
                            <?php 
