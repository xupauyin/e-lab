...
<body>
    <table class="header my-1">
        <tr>
            ...
            <td class="text-header-small mx-1" width="25%">: FM/02/10/DFI <br> &K/ITBSTIKOM</td>
        </tr>
        <tr class="text-left my-1">
            <td class="text-header-small mx-1 remove-border-right">No. Revisi</td>
            <td class="text-header-small mx-1">: 04</td>
        </tr>
        <tr>
            <td class="text-center text-heading" rowspan="2">JURNAL PERSONAL LABORAN</td>
    ...
    <table class="no-border table-small">
        <tr>
            <td class="no-border" style="width:50%;">Nama laboran</td>
            <td class="no-border">:</td>
            <td class="no-border">{{ isset($nama_laboran) && $nama_laboran != '' ? $nama_laboran : '' }}</td>
        </tr>
        <tr>
            <td class="no-border">Laboratorium</td>
            <td class="no-border">:</td>
    ...
    <table class="header text-center">
        <tr>
            ...
            <td width="25%"><strong>Uraian Kegiatan</strong></td>
            <td width="10%"><strong>Waktu</strong></td>
            <td width="20%"><strong>Catatan Pihak Terkait</strong></td>
            <td width="15%"><strong>Paraf Pihak Terkait</strong></td>
        </tr>
        @foreach($jurnal as $i)
        <tr>
            <td>{{ $n++ }}</td>
            <td>{{ $i->uraian_kgt }}</td>
            <td>{{ $i->waktu_jurnal }}</td>
            <td>{{ $i->ctt_pihak }}</td>
            <td></td>
        </tr>
        @endforeach
